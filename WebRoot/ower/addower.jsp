...
<body>
	<div class="am-cf am-padding">
		<div class="am-fl am-cf">
			<strong class="am-text-primary am-text-lg">添加业主</strong> / <small>Add
				Ower</small>
		</div>
	</div>
	...
	<div class="am-g">
		...
		<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
			<form class="am-form am-form-horizontal" id="addOwerForm"
				data-am-validato>
				<div class="am-form-group">
					<label for="user-name" class="am-u-sm-3 am-form-label">姓名 </label>
					<div class="am-u-sm-9">
						<input type="text" style="width:200px" placeholder="业主名 / Name"
							name="oname" onblur="checkName(this)"> <small
							class="error"></small>
					</div>
				</div>
				...
				<div class="am-form-group">
					...
					<div class="am-u-sm-9">
						<input type="text" style="width:250px"
							placeholder="输入你的身份证号 / Identity" name="identity"
				...
				<div class="am-form-group">
					<label for="user-phone" class="am-u-sm-3 am-form-label">入住时间
					</label>
					<div class="am-u-sm-9">
						<input type="text" name="intime" id="intime" style="width:200px"
							class="am-form-field" / onBlur="checkTime(this)"> <small
							class="error"></small>
					</div>
				</div>
				<div class="am-form-group">
					...
					<div class="am-u-sm-9">
						<textarea type="text" placeholder="" name="remark" />
