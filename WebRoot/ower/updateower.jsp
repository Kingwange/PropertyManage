...
<body>
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf">
			<strong class="am-text-primary am-text-lg">业主管理</strong> / <small><a
			...
			<div class="am-tab-panel am-fade am-in am-active" id="job-tag">
				<form class="am-form" id="updateOwerForm" method="post">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="oname" width="50" value='<s:property value="oname"/>'
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="intime" id="intime" width="50"
								value='<s:property value="intime"/>' onBlur="checkTime(this)">
					...
					<div class="owerupdate">
						<button style="" type="button"
							class="am-btn am-btn-primary am-btn-xs" onclick="updateOwer()"
