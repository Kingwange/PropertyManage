      ...
      <div class="am-u-sm-12">
        ...
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="ower-ID">ID</th><th class="ower-name">业主姓名</th><th class="ower-identity">身份证号</th><th class="ower-tel">联系电话</th><th class="ower-intime">入住时间</th>
               
                <th class="ower-remark">备注</th> <th width="150px">操作</th>
          ...
          <tbody>
          	<s:iterator value="pageBean.list"  >
          		<tr>
          			...
          			<td><button type="button" class="am-btn am-btn-xs am-btn-default am-radius" onclick='getUpdateOwerPage(<s:property value="oid"/>)'>修改</button>
          			<button type="button" class="am-btn am-btn-xs am-btn-default am-radius" style="color: red" onclick='deleteOwer(<s:property value="oid"/>)'>删除</button>
          			</td>
          			</s:if>
          		</tr>
          	</s:iterator>
