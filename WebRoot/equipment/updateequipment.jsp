			...
			<div class="am-tab-panel am-fade am-in am-active" id="job-tag">
				<form class="am-form" id="updateEquipmentForm" method="post">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="ename" width="50" value='<s:property value="ename"/>'
								onchange="checkEquipmentname(this)"><small class="error"></small>
						</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="enumber" width="50" value='<s:property value="enumber"/>'
								onblur="checkNumber(this)"><small class="error"></small>
						</div>
						<div class="am-u-sm-6 am-text-right"></div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="vendor" width="50" value='<s:property value="vendor"/>'
								onblur="checkNametype(this)"><small class="error"></small>
						</div>
						<div class="am-u-sm-6 am-text-right"></div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="producedate" id="producedate" width="50"
								value='<s:property value="producedate"/>'
								onblur="checkTime(this)"><small class="error"></small>
						</div>
						<div class="am-u-sm-6 am-text-right"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="maintenancetime" width="50"
								value='<s:property value="maintenancetime"/>'>
						</div>
						<div class="am-u-sm-6 am-text-right"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<select data-am-selected="{btnSize: 'sm'}" style="width:150px"
								class="am-input-sm" id="sid" name="security.sid"
								required="required">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:300px" class="am-checkbox-inline"
								name="remark" width="50" value='<s:property value="remark"/>'>
