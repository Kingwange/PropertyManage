...
<body>
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加设备信息</strong> / <small>Add Equipment</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" id="addEquipmentForm" data-am-validato>
          <div class="am-form-group">
            <label  class="am-u-sm-3 am-form-label">设备名称</label>
            <div class="am-u-sm-9">
           <input type="text"  id="ename" name="ename" placeholder="设备名称/ Ename"/>
            </div>
          </div>
           <div class="am-form-group">
            <label  class="am-u-sm-3 am-form-label">数量</label>
            <div class="am-u-sm-9">
                <input type="text"  id="enumber" name="enumber" placeholder="设备数量/ Number"/>
            </div>
          </div>
           <div class="am-form-group">
            <label  class="am-u-sm-3 am-form-label">生产厂商</label>
            <div class="am-u-sm-9">
             <input type="text"  id="vendor" name="vendor" placeholder="生产厂商/ Vendor"  />
            </div>
            </div>
            <div class="am-form-group">
            <label  class="am-u-sm-3 am-form-label">生产日期</label>
            <div class="am-u-sm-9">
             <input type="text"  id="producedate" name="producedate" placeholder="生产日期/ Producedate" />
            </div>
            </div>
            <div class="am-form-group">
            <label  class="am-u-sm-3 am-form-label">检修周期</label>
            <div class="am-u-sm-9">
             <input type="text"  id="maintenancetime" name="maintenancetime" placeholder="检修周期/ Maintenancetime"  />
            </div>
            </div>
            <div class="am-form-group">
          ...
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <button type="button" class="am-btn am-btn-primary" onclick="saveEquipment()">保存</button>
            </div>
          </div>
        </form>
      </div>
