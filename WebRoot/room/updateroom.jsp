			...
			<div class="am-tab-panel am-fade am-in am-active" id="job-tag">
				<form class="am-form" id="updateRoomForm" method="post">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<select data-am-selected="{btnSize: 'sm'}" style="width:150px"
								class="am-input-sm" id="bid" name="building.bid"
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="rname" width="50" value='<s:property value="rname"/>'
								onchange="checkRoomName(this)"> <small class="error"></small>
						</div>
						<div class="am-u-sm-6 am-text-right"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<select data-am-selected="{btnSize: 'sm'}" style="width:150px"
								class="am-input-sm" id="oid" name="ower.oid" required="required"
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<select style="width:150px" class="am-input-sm" name="type"
								required="required" onchange="checktype(this)">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="rarea" width="50" value='<s:property value="rarea"/>'
								onblur="checkArea(this)" /> <small class="error"></small>
						</div>
						<div class="am-u-sm-6 am-text-right"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<select data-am-selected="{btnSize: 'sm'}" style="width:150px"
								class="am-input-sm" id="id" name="users.id" required="required"
								onchange="checktype(this)">
								<option value='<s:property value="users.id" />'><s:property
										value="users.username" /></option>
					...
					<div class="owerupdate">
						<button style="" type="button"
							class="am-btn am-btn-primary am-btn-xs" onclick="updateRoom()"
							id="buttonBtn">确认修改</button>
					</div>
					<br>
				</form>
