...
<html>
  ...
  <body>
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">房间信息</strong> / <small>Room</small></div>
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            ...
            <select data-am-selected="{btnSize: 'sm'}" class="am-input-sm"
					  ...
					  <option value="${querybuild}">请选择楼宇</option>
            ...
            <select data-am-selected="{btnSize: 'sm'}" class="am-input-sm"
					  ...
					  <option value="${queryower}">请选择业主</option>
      ...
      <div class="am-u-md-3 am-cf">
        <div class="am-fr">
          <div class="am-input-group am-input-group-sm"> 
			<input type="text" class="am-form-field" id="queryroom" name="queryroom" placeholder="房间号/ Rname" value="${queryroom}">
                <span class="am-input-group-btn">
                  <button class="am-btn am-btn-default" type="button" onclick="findAllRoom(1)">搜索</button>
                </span>       
          </div>   
        </div> 
      </div>
          	...
          	<s:iterator value="pageBean.list"  >
          		<tr>
                    ...
                    <td ><s:property value="rarea"/>平方米</td> 	
          			...
          			<td><button type="button" class="am-btn am-btn-xs am-btn-default am-radius" onclick='getUpdateRoomPage(<s:property value="rid"/>)'>修改</button>
          			<button type="button" class="am-btn am-btn-xs am-btn-default am-radius" style="color: red" onclick='deleteRoom(<s:property value="rid"/>)'>删除</button>
          			</td>
          			</s:if>
          		</tr>
          	</s:iterator>
                    ...
                    <td></td>
                     ...
                     <td colspan="4"  class="tocenter">
                        ...
                        <s:else>
                             ...
                             <a onclick='findAllRoom(<s:property value="%{pageBean.currentPage-1}"/>)'>上一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
                         </s:else>
                         <s:if test="%{pageBean.currentPage != pageBean.totalPage}">
                             <a onclick='findAllRoom(<s:property value="%{pageBean.currentPage+1}"/>)'>下一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
                             <a onclick='findAllRoom(<s:property value="pageBean.totalPage"/>)'>末页</a>
                         </s:if>
