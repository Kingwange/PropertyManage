...
<body>
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加住户信息</strong> / <small>Add Resident</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" id="addResidentForm" data-am-validato>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="rsname" placeholder="住户名/ Rname" name="rsname">
            </div>
          </div>
          <div class="am-form-group">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
           <input type="text"  id="identity" name="identity" placeholder="身份证/ Identity"  >
            </div>
          </div>
          <div class="am-form-group">
          ...
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <button type="button" class="am-btn am-btn-primary" onclick="saveResident()">保存</button>
            </div>
          </div>
        </form>
      </div>
