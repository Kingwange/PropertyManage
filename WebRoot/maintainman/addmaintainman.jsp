...
<body>
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加维修人员</strong> / <small>Add Maintainman</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" id="addMaintainmanForm" data-am-validato>
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 </label>
            <div class="am-u-sm-9">
              <input type="text" id="name" style="width:150px"  placeholder="姓名 / Name" name="name">
            </div>
          </div>

          <div class="am-form-group">
            <label for="user-phone" class="am-u-sm-3 am-form-label">维修类别 </label>
            <div class="am-u-sm-9">
               <select  style="width:150px" class="am-input-sm" name="repairtype" required="required">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" style="width:250px" id="ower-tel" placeholder="输入你的联系方式 / Tel" name="tel">
            </div>
          </div>
          <div class="am-form-group">
          ...
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <button type="button" class="am-btn am-btn-primary" onclick="saveMaintainman()">保存</button>
            </div>
          </div>
        </form>
      </div>
