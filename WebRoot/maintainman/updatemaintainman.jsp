			...
			<div class="am-tab-panel am-fade am-in am-active" id="job-tag">
				<form class="am-form" id="updateMaintainmanForm" method="post">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<input type="text" style="width:200px" class="am-checkbox-inline"
								name="name"  value='<s:property value="name"/>' onblur="checkName(this)"/>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-4 am-text-left">
							<select class="class=" style="width:150px"
								am-form-field"" id="repairtype" name="repairtype"
								required="required">
						...
						<div class="am-u-sm-4 am-text-left">
							<select data-am-selected="{btnSize: 'sm'}" style="width:150px"
								...
								<option selected="selected"
									value='<s:property value="users.id" />'><s:property
							...
							</select> <small id="maintain"></small>
						</div>
						<div class="am-u-sm-6 am-text-right"></div>
					</div>
					<br>
