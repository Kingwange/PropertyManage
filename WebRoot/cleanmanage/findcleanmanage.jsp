...
<body>
	<div class="am-cf am-padding">
		<div class="am-fl am-cf">
			<strong class="am-text-primary am-text-lg">保洁信息</strong> / <small>Cleanmanage</small>
		</div>
				...
				<form id="cleanmanageconditionForm">
					<div class="am-input-group am-input-group-sm">
						...
						<input type="text" class="am-form-field" id="queryInfo"
							name="queryInfo" placeholder="清洁工姓名/ Name" value="${queryInfo}">
						<span class="am-input-group-btn">
							<button class="am-btn am-btn-default" type="button"
								onclick="findAllCleanmanage(1)">搜索</button>
						</span>
					</div>
				</form>
			</div>
					...
					<s:iterator value="pageBean.list">
						<tr>
							...
							<td><button type="button"
									...
									onclick='getUpdateCleanmanagePage(<s:property value="cmid"/>)'>修改</button>
								<button type="button"
									class="am-btn am-btn-xs am-btn-default am-radius"
									style="color: red"
									onclick='deleteCleanmanage(<s:property value="cmid"/>)'>删除</button>
							</td>
					...
					<tr>
						...
						<td colspan="4" width="37%" class="tocenter"><s:if
							...
							<s:else>
								...
								<a
									onclick='findAllCleanmanage(<s:property value="%{pageBean.currentPage-1}"/>)'>上一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
							</s:else> <s:if test="%{pageBean.currentPage != pageBean.totalPage}">
								<a
									onclick='findAllCleanmanage(<s:property value="%{pageBean.currentPage+1}"/>)'>下一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
								<a
									onclick='findAllCleanmanage(<s:property value="pageBean.totalPage"/>)'>末页</a>
