...
<body>
	<div class="am-cf am-padding">
		<div class="am-fl am-cf">
			<strong class="am-text-primary am-text-lg">添加保安信息</strong> / <small>Add
				Security</small>
		</div>
	</div>
	...
	<div class="am-g">
		...
		<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
			<form class="am-form am-form-horizontal" id="addSecurityForm"
				data-am-validato>
				<div class="am-form-group">
					<label class="am-u-sm-3 am-form-label">保安姓名 </label>
					<div class="am-u-sm-9">
						<input type="text" style="width:200px" placeholder="保安名/ Name"
							name="sname" onblur="checkName(this)"> <small
							class="error"></small>
					</div>
				</div>
				...
				<div class="am-form-group">
					...
					<div class="am-u-sm-9">
						<input type="text" style="width:200px" placeholder="身份证/ Identity"
							name="identity" onblur="checkIdentity(this)"> <small
							class="error"></small>
					</div>
				</div>
				<div class="am-form-group">
				...
				<div class="am-form-group">
					...
					<div class="am-u-sm-9">
						<input type="text" style="width:200px" name="address"
							placeholder="家庭住址/ Address">
					</div>
				</div>
				<div class="am-form-group">
					<label class="am-u-sm-3 am-form-label">负责区域</label>
					<div class="am-u-sm-9">
						<input type="text" style="width:200px" name="territory"
							placeholder="负责区域/ Territory">
					</div>
				</div>
				<div class="am-form-group">
				...
				<div class="am-form-group">
					...
					<div class="am-u-sm-9">
						<textarea type="text" name="remark" placeholder="" />
				...
				<div class="am-form-group">
					<div class="am-u-sm-9 am-u-sm-push-3">
						<button type="button" class="am-btn am-btn-primary"
							onclick="saveSecurity()">保存</button>
					</div>
				</div>
			</form>
		</div>
