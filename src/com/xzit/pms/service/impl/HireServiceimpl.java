...
public class HireServiceimpl implements HireService {
	...
	public PageBean queryForPage(int pageSize, int currentPage, String queryInfo,
		...
		String hql = "select count(*) from Hire where hname like '%" +queryInfo+"%'  and rid "+queryroom+"  order by hid asc";
		...
		String hql1="from Hire where hname like '%" +queryInfo+"%'  and rid "+queryroom+"  order by hid asc";
