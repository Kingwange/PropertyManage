...
public class MaintainServiceimpl implements MaintainService {
	...
	public PageBean queryForPage(int pageSize, int currentPage,
		...
		String hql = "select count(*) from Maintain where rid like '%" +queryroom+"%' and type like '%" +querytype+"%' and mmid like '%" +queryrepairtype+"%' order by mid asc";
		...
		String hql1="from Maintain where rid like '%" +queryroom+"%' and type like '%" +querytype+"%' and mmid like '%" +queryrepairtype+"%' order by mid asc";
